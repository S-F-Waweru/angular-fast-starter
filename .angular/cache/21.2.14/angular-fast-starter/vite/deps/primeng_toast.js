...
function ToastItem_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("ngTemplateOutlet", ctx_r0.headlessTemplate)("ngTemplateOutletContext", ɵɵpureFunction2(2, _c2, ctx_r0.message, ctx_r0.onCloseIconClick));
  }
}
...
function ToastItem_Conditional_3_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵattribute("class", ctx_r0.cx("closeButton"))("aria-label", ctx_r0.closeAriaLabel);
    ɵɵadvance();
...
function ToastItem_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", ctx_r0.template)("ngTemplateOutletContext", ɵɵpureFunction1(7, _c3, ctx_r0.message));
    ɵɵadvance();
...
var Toast = class _Toast extends BaseComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    contentQueries: function Toast_ContentQueries(rf, ctx, dirIndex) {
      if (rf & 1) {
        ɵɵcontentQuery(dirIndex, _c4, 5)(dirIndex, _c5, 5)(dirIndex, PrimeTemplate, 4);
      }
      if (rf & 2) {
        let _t2;
