...
var _AppLoadingStateComponent = class _AppLoadingStateComponent {
  constructor() {
    this.label = input("Loading", ...ngDevMode ? [{ debugName: "label" }] : []);
  }
};
_AppLoadingStateComponent.\u0275fac = function AppLoadingStateComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AppLoadingStateComponent)();
};
_AppLoadingStateComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppLoadingStateComponent, selectors: [["app-loading-state"]], inputs: { label: [1, "label"] }, decls: 5, vars: 1, consts: [[1, "grid", "min-h-40", "place-items-center", "px-4", "py-8", "text-center"], ["ariaLabel", "Loading", "styleClass", "size-10"], [1, "mt-3", "text-sm", "text-muted-color"]], template: function AppLoadingStateComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "div");
    \u0275\u0275element(2, "p-progressSpinner", 1);
...
}, dependencies: [ProgressSpinnerModule, ProgressSpinner], encapsulation: 2, changeDetection: 0 });
var AppLoadingStateComponent = _AppLoadingStateComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AppLoadingStateComponent, [{
    type: Component,
    args: [{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppLoadingStateComponent, { className: "AppLoadingStateComponent", filePath: "src/app/shared/ui/loading-state/loading-state.component.ts", lineNumber: 18 });
})();

export {
  AppLoadingStateComponent
};
//# sourceMappingURL=chunk-7BH6NQVT.js.map
