...
// src/app/shared/ui/icon-button/icon-button.component.ts
var _AppIconButtonComponent = class _AppIconButtonComponent {
  constructor() {
    this.label = input.required(...ngDevMode ? [{ debugName: "label" }] : []);
    this.icon = input.required(...ngDevMode ? [{ debugName: "icon" }] : []);
    this.intent = input("ghost", ...ngDevMode ? [{ debugName: "intent" }] : []);
...
_AppIconButtonComponent.\u0275fac = function AppIconButtonComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AppIconButtonComponent)();
};
_AppIconButtonComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppIconButtonComponent, selectors: [["app-icon-button"]], inputs: { label: [1, "label"], icon: [1, "icon"], intent: [1, "intent"], disabled: [1, "disabled"], loading: [1, "loading"] }, outputs: { clicked: "clicked" }, decls: 1, vars: 9, consts: [["type", "button", "tooltipPosition", "bottom", 3, "onClick", "icon", "severity", "outlined", "text", "rounded", "disabled", "loading", "ariaLabel", "pTooltip"]], template: function AppIconButtonComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-button", 0);
    \u0275\u0275listener("onClick", function AppIconButtonComponent_Template_p_button_onClick_0_listener() {
      return ctx.clicked.emit();
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275property("icon", ctx.icon())("severity", ctx.severity())("outlined", ctx.intent() === "secondary")("text", ctx.intent() === "ghost")("rounded", true)("disabled", ctx.disabled())("loading", ctx.loading())("ariaLabel", ctx.label())("pTooltip", ctx.label());
  }
}, dependencies: [ButtonModule, Button, TooltipModule, Tooltip], encapsulation: 2, changeDetection: 0 });
var AppIconButtonComponent = _AppIconButtonComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AppIconButtonComponent, [{
    type: Component,
    args: [{
  ...
  }], null, { label: [{ type: Input, args: [{ isSignal: true, alias: "label", required: true }] }], icon: [{ type: Input, args: [{ isSignal: true, alias: "icon", required: true }] }], intent: [{ type: Input, args: [{ isSignal: true, alias: "intent", required: false }] }], disabled: [{ type: Input, args: [{ isSignal: true, alias: "disabled", required: false }] }], loading: [{ type: Input, args: [{ isSignal: true, alias: "loading", required: false }] }], clicked: [{ type: Output, args: ["clicked"] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppIconButtonComponent, { className: "AppIconButtonComponent", filePath: "src/app/shared/ui/icon-button/icon-button.component.ts", lineNumber: 28 });
})();
...
//# sourceMappingURL=chunk-IN6YF4N5.js.map
