  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    template: function ToastItem_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("pBind", ctx.ptm("message"))("@messageState", \u0275\u0275pureFunction1(11, _c12, \u0275\u0275pureFunction4(6, _c05, ctx.showTransformOptions, ctx.hideTransformOptions, ctx.showTransitionOptions, ctx.hideTransitionOptions)));
...
var _AppComponent = class _AppComponent {
  constructor() {
    ...
    this.layoutPreferences = inject(LayoutPreferenceService);
  }
};
_AppComponent.\u0275fac = function AppComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AppComponent)();
};
_AppComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], decls: 3, vars: 0, consts: [["position", "top-right"]], template: function AppComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "router-outlet")(1, "p-toast", 0)(2, "p-confirmDialog");
  }
}, dependencies: [RouterOutlet, ConfirmDialogModule, ConfirmDialog, ToastModule, Toast], encapsulation: 2, changeDetection: 0 });
...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-EYWRRFJJ.js").then((m5) => m5);
...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-LPDX2IGM.js").then((m5) => m5.PublicShellComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-KK56FX3L.js").then((m5) => m5.HomePage)
      }
    ]
  },
  {
    path: "auth",
    loadComponent: () => import("./chunk-2KA4IKAB.js").then((m5) => m5.AuthShellComponent),
    children: [
      {
        path: "",
        pathMatch: "full",
      ...
      {
        path: "login",
        loadComponent: () => import("./chunk-GVB4NJKC.js").then((m5) => m5.LoginPage)
      },
      {
        path: "register",
        loadComponent: () => import("./chunk-LA6GV2WP.js").then((m5) => m5.RegisterPage)
      },
      {
        path: "forgot-password",
        loadComponent: () => import("./chunk-EJUUJLAV.js").then((m5) => m5.ForgotPasswordPage)
      },
      {
        path: "reset-password",
        loadComponent: () => import("./chunk-BCSCFK6Y.js").then((m5) => m5.ResetPasswordPage)
      }
    ]
  },
  {
    ...
    loadComponent: () => import("./chunk-RLFZ6VQZ.js").then((m5) => m5.AppShellComponent),
    children: [
      {
        path: "",
        pathMatch: "full",
      ...
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-W64RLVNG.js").then((m5) => m5.DashboardPage)
      },
      {
        path: "customers",
        loadChildren: () => import("./chunk-OVKRVAIB.js").then((m5) => m5.CUSTOMERS_ROUTES)
      },
      {
        path: "shell-demos",
        loadChildren: () => import("./chunk-FFLINUEE.js").then((m5) => m5.SHELL_DEMOS_ROUTES)
      },
      {
        path: "settings",
        loadComponent: () => import("./chunk-BTGHAHZ3.js").then((m5) => m5.SettingsPage)
      },
      {
        path: "profile",
        loadComponent: () => import("./chunk-XXOJ2TEU.js").then((m5) => m5.ProfilePage)
      }
    ]
  },
  {
...
var k = { root: o18, header: r18, headerCell: e14, columnTitle: d5, row: t8, bodyCell: l4, footerCell: c7, columnFooter: n4, footer: a8, dropPoint: i8, columnResizer: s5, resizeIndicator: g, sortIcon: u, loadingIcon: b, rowToggleButton: p2, filter: m, paginatorTop: h, paginatorBottom: f3, colorScheme: v };
...
var d31 = { root: o83, node: r81, nodeIcon: e54, nodeToggleButton: t40, loadingIcon: c25, filter: n37 };
...
var k3 = { root: o85, header: r83, headerCell: e56, columnTitle: t41, row: c26, bodyCell: n38, footerCell: d33, columnFooter: l18, footer: i27, columnResizer: a41, resizeIndicator: g5, sortIcon: s11, loadingIcon: u6, nodeToggleButton: h4, paginatorTop: b4, paginatorBottom: f10, colorScheme: m3 };
